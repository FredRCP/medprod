export const TIPOS_PRODUCAO = [
  ...
  { value: 'dialise_peritoneal_consulta',   label: 'Diálise peritoneal - Consulta mensal' },
  { value: 'dialise_peritoneal_capd',       label: 'Diálise peritoneal (CAPD)' },
  { value: 'dialise_peritoneal_dpa',        label: 'Diálise peritoneal (DPA)' },
  { value: 'dialise_peritoneal_intermitente', label: 'Diálise peritoneal intermitente' },
